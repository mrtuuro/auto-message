...
const (
	...
	SuccessMessagesRetrieved  = "MESSAGES_RETRIEVED"
)
...
var SuccessMessages = map[string]string{
	...
	SuccessMessagesRetrieved:  "Messages susccesfully retrieved.",
}

var StatusCodes = map[string]int{

	SuccessHealthCheck:        http.StatusOK,
	SuccessOperationCompleted: http.StatusNoContent,
	SuccessMessagesRetrieved:  http.StatusOK,
